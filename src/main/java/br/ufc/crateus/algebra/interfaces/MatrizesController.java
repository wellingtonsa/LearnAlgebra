...
public class MatrizesController extends Application implements Initializable {
	...
	public void start(Stage primaryStage) throws Exception {
		MatrizesController.myStage = primaryStage;
		Pane pane = (Pane) FXMLLoader.load(FXMLResources.MATRIZES);
